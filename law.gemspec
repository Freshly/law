...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "spicerack", ">= 0.17.2", "< 1.0"
  ...
  spec.add_development_dependency "rspice", ">= 0.17.2", "< 1.0"
  spec.add_development_dependency "spicerack-styleguide", ">= 0.17.2", "< 1.0"
